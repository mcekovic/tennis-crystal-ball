...
public class NoTBSetOutcomeTest {

	@Test
	public void testEqualP() {
		SetOutcome set = new SetOutcome(0.5, 0.5, false);
	...
	public void testFinalStep() {
		SetOutcome set = new SetOutcome(0.8, 0.4, false);
	...
	public void testDeuce() {
		SetOutcome game = new SetOutcome(0.75, 0.25, false);
