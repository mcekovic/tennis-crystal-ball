...
BEGIN
	BEGIN
		...
		(rank_date, player_id, rank, elo_rating, hard_rank, hard_elo_rating, clay_rank, clay_elo_rating, grass_rank, grass_elo_rating, carpet_rank, carpet_elo_rating, outdoor_rank, outdoor_elo_rating, indoor_rank, indoor_elo_rating)
		VALUES
		(p_rank_date, p_player_id, p_rank, p_elo_rating, p_hard_rank, p_hard_elo_rating, p_clay_rank, p_clay_elo_rating, p_grass_rank, p_grass_elo_rating, p_carpet_rank, p_carpet_elo_rating, p_outdoor_rank, p_outdoor_elo_rating, p_indoor_rank, p_indoor_elo_rating);
