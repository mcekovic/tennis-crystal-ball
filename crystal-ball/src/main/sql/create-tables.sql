...
CREATE TABLE player (
	...
	height SMALLINT,
	weight SMALLINT,
	handed CHAR(1) CHECK (handed IN ('R', 'L')),
...
CREATE TABLE match (
	...
	winner_country CHAR(2) NOT NULL,
...
ALTER TABLE tournament_event ADD COLUMN final_id INTEGER REFERENCES match (match_id) ON DELETE SET NULL;
...
SELECT match_id, set, minutes, sets, w_sv_gms + l_sv_gms AS games, w_sv_pt + l_sv_pt AS points,
	w_ace, w_df, w_sv_pt, w_1st_in, w_1st_won, w_sv_pt - w_1st_in - w_df AS w_2nd_in, w_2nd_won, w_sv_gms, w_bp_saved, w_bp_faced,
	l_sv_pt AS w_rt_pt, l_1st_in - l_1st_won AS w_rt_1st_won, l_sv_pt - l_1st_in - l_2nd_won AS w_rt_2nd_won, l_bp_faced - l_bp_saved AS w_bp_won, l_bp_faced AS w_bp,
	...
	l_ace, l_df, l_sv_pt, l_1st_in, l_1st_won, l_sv_pt - l_1st_in - l_df AS l_2nd_in, l_2nd_won, l_sv_gms, l_bp_saved, l_bp_faced,
	w_sv_pt AS l_rt_pt, w_1st_in - w_1st_won AS l_rt_1st_won, w_sv_pt - w_1st_in - w_2nd_won AS l_rt_2nd_won, w_bp_faced - w_bp_saved AS l_bp_won, w_bp_faced AS l_bp,
