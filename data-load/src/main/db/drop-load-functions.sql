...
DROP FUNCTION load_current_event(TEXT, DATE, TEXT, TEXT, TEXT, BOOLEAN, TEXT, SMALLINT);
DROP FUNCTION find_current_event(TEXT);
DROP FUNCTION load_current_match(TEXT, SMALLINT, INTEGER, INTEGER, DATE, TEXT, BOOLEAN, TEXT, SMALLINT,
	TEXT, TEXT, SMALLINT, TEXT, TEXT, TEXT, SMALLINT, TEXT, SMALLINT, TEXT, TEXT);
DROP FUNCTION load_player_current_event_result(TEXT, INTEGER, TEXT, REAL);
