...
class ATPTennisLoader {
	...
	def loadAdditionalTournamentData(Sql sql) {
		if (full) {
			...
			atpTourMatchLoader.loadTournament(1968, 'manchester', 7310, false, null, null, ['R32', 'R64'])
			atpTourMatchLoader.loadTournament(1968, 'london', 311)
			atpTourMatchLoader.loadTournament(1968, 'dublin', 2029, false, null, 'G', ['R32'])
			atpTourMatchLoader.loadTournament(1968, 'buenos-aires', 303, false, null, null, ['R32', 'R64'])
			atpTourMatchLoader.loadTournament(1969, 'perth', 243, false, null, 'G', ['R16', 'R32'])
			atpTourMatchLoader.loadTournament(1969, 'hobart', 713, false, null, 'G')
			atpTourMatchLoader.loadTournament(1969, 'new-york', 2058, false, null, 'P')
			atpTourMatchLoader.loadTournament(1969, 'durban', 260, false, null, null, ['R32', 'R64'])
			atpTourMatchLoader.loadTournament(1969, 'brussels', 406, false, null, 'C')
			atpTourMatchLoader.loadTournament(1969, 'dublin', 2029, false, null, 'G', ['R32'])
			atpTourMatchLoader.loadTournament(1969, 'las-vegas', 413, false, null, 'H')
			atpTourMatchLoader.loadTournament(1970, 'north-miami-beach', 681)
			atpTourMatchLoader.loadTournament(1970, 'richmond', 802, false, null, 'H')
			atpTourMatchLoader.loadTournament(1970, 'salisbury', 355)
			atpTourMatchLoader.loadTournament(1970, 'chorpus-christi', 6816)
			atpTourMatchLoader.loadTournament(1970, 'los-angeles', 6811)
			atpTourMatchLoader.loadTournament(1970, 'macon', 2066)
			atpTourMatchLoader.loadTournament(1970, 'szczecin', 657, false, null, 'P')
			atpTourMatchLoader.loadTournament(1970, 'wembley', 6812)
			atpTourMatchLoader.loadTournament(1970, 'san-juan', 6817, false, null, null, ['R64'])
			atpTourMatchLoader.loadTournament(1970, 'durban', 260, false, null, null, ['R64'])
			atpTourMatchLoader.loadTournament(1970, 'st-petersburg', 6818, false, null, null, ['R64'])
			atpTourMatchLoader.loadTournament(1970, 'bermuda', 436)
			atpTourMatchLoader.loadTournament(1970, 'dallas', 388, false, null, 'P')
			atpTourMatchLoader.loadTournament(1970, 'houston', 405, false, null, 'H')
			atpTourMatchLoader.loadTournament(1970, 'bournemouth', 347)
			atpTourMatchLoader.loadTournament(1970, 'atlanta', 412, false, null, 'H')
			atpTourMatchLoader.loadTournament(1970, 'las-vegas', 413, false, null, 'H')
			atpTourMatchLoader.loadTournament(1970, 'brussels', 406, false, null, 'C')
			atpTourMatchLoader.loadTournament(1970, 'manchester', 7310)
			atpTourMatchLoader.loadTournament(1970, 'bristol', 313)
			atpTourMatchLoader.loadTournament(1970, 'birmingham', 350, false, null, 'G', ['R32', 'R64'], 'Nottingham')
			atpTourMatchLoader.loadTournament(1970, 'eastbourne', 2049)
			atpTourMatchLoader.loadTournament(1970, 'newport', 2050, false, null, null, ['R32', 'R64'])
			atpTourMatchLoader.loadTournament(1970, 'dublin', 2029, false, null, 'G', ['R32'])
			atpTourMatchLoader.loadTournament(1970, 'hoylake', 6830, false, null, null, ['R32', 'R64'])
			atpTourMatchLoader.loadTournament(1970, 'leicester', 6831)
			atpTourMatchLoader.loadTournament(1970, 'munich', 804, false, null, 'C')
			atpTourMatchLoader.loadTournament(1970, 'fort-worth', 653)
			atpTourMatchLoader.loadTournament(1970, 'merion', 2030, false, null, 'H')
			atpTourMatchLoader.loadTournament(1970, 'vancouver', 2048)
			atpTourMatchLoader.loadTournament(1970, 'midland', 6832)
			atpTourMatchLoader.loadTournament(1970, 'tucson', 6833)
			atpTourMatchLoader.loadTournament(1970, 'antwerp', 430, false, 'M', 'P')
			atpTourMatchLoader.loadTournament(1971, 'bristol', 313)
			atpTourMatchLoader.loadTournament(1971, 'eastbourne', 2049)
			atpTourMatchLoader.loadTournament(1971, 'senigallia', 6834, false, null, null, ['R64'])
			atpTourMatchLoader.loadTournament(1972, 'macon', 2066)
			atpTourMatchLoader.loadTournament(1972, 'tokyo', 329, false, null, null, ['R32'])
			atpTourMatchLoader.loadTournament(1973, 'charleston', 6945)
			atpTourMatchLoader.loadTournament(1973, 'kitzbuehel', 319)
			atpTourMatchLoader.loadTournament(1974, 'lakeway', 6836)
			atpTourMatchLoader.loadTournament(1974, 'hong-kong', 336)
			atpTourMatchLoader.loadTournament(1975, 'australian-open', 580, false, null, 'G')
			atpTourMatchLoader.loadTournament(1976, 'birmingham', 350, false, null, 'G')
			atpTourMatchLoader.loadTournament(1976, 'pepsi-grand-slam', 1725, false, null, null, [], 'Pepsi Grand Slam')
			atpTourMatchLoader.loadTournament(1977, 'birmingham', 350, false, null, 'G')
			atpTourMatchLoader.loadTournament(1980, 'indian-wells', 404, false, 'B', null, [], null, 728)
			atpTourMatchLoader.loadTournament(1981, 'wimbledon', 540)
//			atpTourMatchLoader.loadTournament(2007, 'vina-del-mar', 505)
			atpTourMatchLoader.loadTournament(2008, 'moscow', 438)
