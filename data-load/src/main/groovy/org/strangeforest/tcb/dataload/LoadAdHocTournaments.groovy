...
//	matchLoader.load(fetchTournament(2016, 'Quito', 7161))
	sqlPool.withSql {sql ->
		...
		atpWorldTourMatchLoader.loadTournament(1970, 'newport', 2050, null, false, ['R32', 'R64'])
		atpWorldTourMatchLoader.loadTournament(1970, 'dublin', 2029, null, false, ['R32'])
		atpWorldTourMatchLoader.loadTournament(1970, 'hoylake', 6830, null, false, ['R32', 'R64'])
		atpWorldTourMatchLoader.loadTournament(1970, 'munich', 804)
		atpWorldTourMatchLoader.loadTournament(1970, 'merion', 2030, null, false, ['R64'])
		atpWorldTourMatchLoader.loadTournament(1970, 'midland', 6832)
		atpWorldTourMatchLoader.loadTournament(1970, 'tucson', 6833)
		atpWorldTourMatchLoader.loadTournament(1971, 'senigallia', 6834, null, false, ['R32', 'R64'])
		atpWorldTourMatchLoader.loadTournament(1972, 'macon', 2066)
		atpWorldTourMatchLoader.loadTournament(1972, 'tokyo', 329, null, false, ['R16', 'R32'])
