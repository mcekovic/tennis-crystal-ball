...
public class PlayerTimelineTest {
	...
	public void simplePlayerTimelineIsCreated() {
		...
		timeline.addItem(new PlayerTimelineItem(3, "Miami", 2002, 203, toDate(LocalDate.of(2002, 3, 5)), "M", "H", false, "Miami", "QF"));
		timeline.addItem(new PlayerTimelineItem(3, "Miami", 2003, 303, toDate(LocalDate.of(2003, 3, 8)), "M", "H", false, "Miami", "F"));

		timeline.addItem(new PlayerTimelineItem(4, "Hamburg Masters", 2001, 104, toDate(LocalDate.of(2001, 4, 20)), "M", "C", false, "Hamburg Masters", "R16"));
		timeline.addItem(new PlayerTimelineItem(4, "Hamburg Masters", 2008, 804, toDate(LocalDate.of(2008, 4, 25)), "A", "C", false, "Hamburg", "QF"));

		timeline.addItem(new PlayerTimelineItem(2, "Roland Garros", 2002, 202, toDate(LocalDate.of(2002, 5, 10)), "G", "C", false, "Roland Garros", "R16"));
		timeline.addItem(new PlayerTimelineItem(2, "Roland Garros", 2003, 302, toDate(LocalDate.of(2003, 5, 18)), "G", "C", false, "Roland Garros", "R32"));
		timeline.addItem(new PlayerTimelineItem(2, "Roland Garros", 2004, 402, toDate(LocalDate.of(2004, 5, 15)), "G", "C", false, "Roland Garros", "R64"));

		timeline.addItem(new PlayerTimelineItem(5, "Stuttgart", 2001, 104, toDate(LocalDate.of(2001, 7, 20)), "M", "C", false, "Stuttgart Masters", "R32"));
		timeline.addItem(new PlayerTimelineItem(5, "Stuttgart", 2009, 904, toDate(LocalDate.of(2009, 7, 25)), "A", "G", false, "Stuttgart", "SF"));
