...
class MatchRulesTest {
	...
	void setIsNotDeciding() {
		...
		assertThat(BEST_OF_3_MATCH.isDecidingSet(2)).isFalse();
		...
		assertThat(BEST_OF_5_MATCH.isDecidingSet(4)).isFalse();
	}

	@Test
	void setIsDeciding() {
		assertThat(BEST_OF_3_MATCH.isDecidingSet(3)).isTrue();

		assertThat(BEST_OF_5_MATCH.isDecidingSet(5)).isTrue();
	}
}
