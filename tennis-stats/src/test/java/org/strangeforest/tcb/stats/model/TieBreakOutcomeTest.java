...
class TieBreakOutcomeTest {
	...
	@Test
	void testEqualP() {
		var tieBreak = new TieBreakOutcome(0.8, 0.2);
	...
	@Test
	void testFinalStep() {
		var tieBreak = new TieBreakOutcome(0.8, 0.4);
	...
	@Test
	void testDeuce() {
		var tieBreak = new TieBreakOutcome(0.75, 0.25);
	...
	@Test
	void testSymmetry() {
		var tieBreakOutcome = new TieBreakOutcome(0.75, 0.25);
