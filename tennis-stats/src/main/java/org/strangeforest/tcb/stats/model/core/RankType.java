...
public enum RankType {
	...
	OUTDOOR_ELO_RANK(ELO, null, false, "Outdoor Elo Ranking", "Out. Elo", null),
	OUTDOOR_ELO_RATING(ELO, OUTDOOR_ELO_RANK, true, "Outdoor Elo Rating", "Outdoor", null),
	INDOOR_ELO_RANK(ELO, null, false, "Indoor Elo Ranking", "In. Elo", null),
	...
	SERVICE_GAME_ELO_RANK(ELO, null, false, "Service Game Elo Ranking", "Svc. Elo", null),
	SERVICE_GAME_ELO_RATING(ELO, SERVICE_GAME_ELO_RANK, true, "Service Game Elo Rating", "Service Game", null),
	RETURN_GAME_ELO_RANK(ELO, null, false, "Return Game Elo Ranking", "Rtn. Elo", null),
	RETURN_GAME_ELO_RATING(ELO, RETURN_GAME_ELO_RANK, true, "Return Game Elo Rating", "Return Game", null),
	TIE_BREAK_ELO_RANK(ELO, null, false, "Tie Break Elo Ranking", "TB Elo", null),
