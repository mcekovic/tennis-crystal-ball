...
public enum TournamentLevelGroup {
	...
	BEST_OF_3(EnumSet.of(TOUR_FINALS, ALT_FINALS, MASTERS, OLYMPICS, ATP_500, ATP_250, OTHERS_TEAM), "Best of 3"),
	BEST_OF_5_IND(EnumSet.of(GRAND_SLAM), "Best of 5"),
	BEST_OF_3_IND(EnumSet.of(TOUR_FINALS, ALT_FINALS, MASTERS, OLYMPICS, ATP_500, ATP_250), "Best of 3");
