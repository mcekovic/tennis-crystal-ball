...
public class RivalriesController extends PageController {
	...
	public ModelAndView h2hPerformance(
		...
		PlayerPerformanceEx perf1 = performanceService.getPlayerPerformanceEx(playerId1, new PerfStatsFilter(season, level, surface, tournamentId, null, opponent ? playerId2 : null));
		PlayerPerformanceEx perf2 = performanceService.getPlayerPerformanceEx(playerId2, new PerfStatsFilter(season, level, surface, tournamentId, null, opponent ? playerId1 : null));
