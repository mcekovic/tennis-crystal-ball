...
public enum RecordDomain {
	...
	ALT_FINALS("AltFinals", "Alt. Tour Finals", N_A, "level = 'L'", "alt_finals_", "altFinalsMatches", "&level=L"),
	ALL_FINALS("AllFinals", "All Tour Finals (Official and Alternative)", N_A, "level IN ('F', 'L')", null, "tourFinalsMatches", "&level=FL"),
