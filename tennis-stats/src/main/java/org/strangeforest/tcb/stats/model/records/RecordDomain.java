...
public enum RecordDomain {
	...
	ALL(N_A, N_A, N_A, ALL_TOURNAMENTS, N_A, "matches", N_A),
	...
	BIG_TOURNAMENTS("Big", "Big", "(Grand Slam, Tour Finals, Masters, Olympics)", "level IN ('G', 'F', 'M', 'O')", null, "hardMatches", N_A),
	...
	SMALL_TOURNAMENTS("Small", "Small", "(ATP 500/CS, ATP 250/WS)", "level IN ('A', 'B')", null, "hardMatches", N_A),
