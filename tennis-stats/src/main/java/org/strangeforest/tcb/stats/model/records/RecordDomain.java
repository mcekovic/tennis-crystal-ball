...
public enum RecordDomain {
	...
	BIG_TOURNAMENTS("Big", "Big", "(Grand Slam, Tour Finals, Masters, Olympics)", "level IN ('G', 'F', 'M', 'O')", null, "matches"),
	ATP_500("ATP500", "ATP 500/CS", N_A, "level = 'A'", "atp500_", "mastersMatches"),
	ATP_250("ATP250", "ATP 250/WS", N_A, "level = 'B'", "atp250_", "mastersMatches"),
	SMALL_TOURNAMENTS("Small", "Small", "(ATP 500/CS, ATP 250/WS)", "level IN ('A', 'B')", null, "matches"),
	...
	NO_1_FILTER(NO_1, NO_1_NAME, N_A, null, "vs_no1", "vsNo1"),
	TOP_5_FILTER(TOP_5, TOP_5_NAME, N_A, null, "vs_top5", "vsTop5"),
	TOP_10_FILTER(TOP_10, TOP_10_NAME, N_A, null, "vs_top10", "vsTop10");
