...
public enum RecordDomain {
	...
	OUTDOOR("Outdoor", "Outdoor", N_A, "indoor = FALSE AND " + ALL_TOURNAMENTS, "outdoor_", "outdoorMatches", "&indoor=false"),
	INDOOR("Indoor", "Indoor", N_A, "indoor AND " + ALL_TOURNAMENTS, "indoor_", "indoorMatches", "&indoor=true"),
