...
public class RankingATPCategory extends RankingCategory {
	...
	public RankingATPCategory() {
		super("ATP Ranking");
		registerRanking("ATP", RecordCategory.N_A);
		...
		register(greatestPointsDifferenceBetweenNo1andNo2(
			"ATPPointsNo1No2Difference", "ATP Points Difference Between No. 1 and No. 2" + ADJUSTMENT, "player_ranking", "rank_points", RecordCategory.N_A,
			"adjust_atp_rank_points(r1.rank_points - r2.rank_points, r1.rank_date)", "adjust_atp_rank_points(r1.rank_points, r1.rank_date)", "adjust_atp_rank_points(r2.rank_points, r1.rank_date)",
			"numeric", null, "Points", "Points Diff."
		));
		register(greatestPointsDifferenceBetweenNo1andNo2(
			"ATPPointsNo1No2DifferencePct", "ATP Points Pct. Difference Between No. 1 and No. 2", "player_ranking", "rank_points", RecordCategory.N_A,
			"round(100 * (r1.rank_points - r2.rank_points) / r2.rank_points)::INTEGER", "r1.rank_points", "r2.rank_points",
