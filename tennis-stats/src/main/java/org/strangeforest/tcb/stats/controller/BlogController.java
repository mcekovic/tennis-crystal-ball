...
public class BlogController extends PageController {
	...
	private static final Collection<String> VALID_BLOG_SECTIONS = asList(DEFAULT_BLOG_SECTION, "eloKfactorTweaks", "gameEvolution", "goatCalculator", "mythBusters", "big4CourtSpeed", "h2hSkew");
